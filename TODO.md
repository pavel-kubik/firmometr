...
- [ ] ISIR (isir.justice.cz) — insolvenční rejstřík, REST + SOAP, minutová aktualizace
- [ ] ARES (Ministerstvo financí) — základní data, DPH status, RES
- [ ] Nespolehliví plátci DPH (gov.cz)
- [ ] Obchodní rejstřík (or.justice.cz) — statutáři, základní sbírka listin

### Search & company profile
- [ ] Vyhledávání podle IČO, názvu firmy, jména osoby
- [ ] Profil firmy — agregovaná data z ARES + ISIR + DPH + OR
- [ ] Risk semafor (zelená / žlutá / červená): insolvence, DPH spolehlivost, věk firmy, poslední změny

### Watchlist & alerts
- [ ] Watchlist — přidat IČO, sledovat změny
- [ ] E-mail alerty (okamžitě / denní souhrn) s nastavitelnou granularitou
- [ ] Hromadný import IČO ze CSV

### Free tier limits
- [ ] Max 5 sledovaných IČO
...
- [ ] Free public lookup pages (IČO detail bez přihlášení, crawlable) — strukturovaná data, schema.org Organization
